...
public class UniRPGGlobal : MonoBehaviour
{
	...
	void Start()
	{
		...
		if (UniRPGGlobal.LoadedLevelName().Equals("unirpg"))
		{
	...
	{
		RestoreAutoItems(UniRPGGlobal.LoadedLevelName());
	...
	private void PerformSave()
	{
		...
		SaveString("scene", UniRPGGlobal.LoadedLevelName());
		...
		SaveAutoItems(UniRPGGlobal.LoadedLevelName());
